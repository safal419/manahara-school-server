...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    classroomImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    cleanWaterImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    environmentImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    founderImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    healthCareImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    libraryImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    ourJourneryImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    outdoorPlayImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Classroom', 'Sports', 'Events', 'Cultural', 'Trips', 'Celebration']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHighlightHighlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Sports', 'Education', 'Culture', 'Arts', 'Events', 'Celebration']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Education', 'Sports', 'Art ', 'Events', 'Celebration', 'Updates']
    >;
...
export interface ApiSchoolEventSchoolEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'school-events';
    singularName: 'school-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Workshop', 'Trip', 'Meeting', 'Health', 'Cultural', 'Sports']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
